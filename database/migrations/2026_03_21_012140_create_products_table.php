...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            // ⚡ Each product must belong to a category or subcategory
            ...
            // Currency (required, provide default value)
            ...
            // Sale type
            $table->enum('sale_type', ['online', 'physical'])->default('');
            ...
            // Optional: parent_id (link to subcategory creation)
            $table->foreignId('parent_id')->nullable()->constrained('categories')->cascadeOnDelete();

            $table->string('new_subcategory')->nullable();
